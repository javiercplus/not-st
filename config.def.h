...
float alpha = 0.85;
static float alpha_unfocused = -1.0;
...
static int cursor_dynamic_color = 1;
static int bold_is_not_bright = 1;
...
static char *openurlcmd[] = {"/bin/sh", "-c", "command -v st-urlhandler >/dev/null 2>&1 && st-urlhandler -o || ~/.local/bin/st-urlhandler -o", "externalpipe", NULL};
static char *copyurlcmd[] = {"/bin/sh", "-c", "command -v st-urlhandler >/dev/null 2>&1 && st-urlhandler -c || ~/.local/bin/st-urlhandler -c", "externalpipe", NULL};
...
static Shortcut shortcuts[] = {
	...
	{ TERMMOD,              XK_Escape,      resetterm,      {.i =  0} },
	{ TERMMOD,              XK_R,           resetterm,      {.i =  0} },
